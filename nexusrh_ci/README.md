...
| Domaine | Couverture |
| ------- | ---------- |
| **Tests automatisés** | **1285 tests verts** (Vitest) sur 25 fichiers — paie, recrutement, absences, contrats, employés, expenses, reporting, training, careers, mobile-money, IA assistant, CNPS, settings (28 tests dont 11 imports conformes BD), référentiels, authentification (plugin + routes), packs législatifs, workflows, security headers, **33 fixtures golden** (902 assertions)  |
