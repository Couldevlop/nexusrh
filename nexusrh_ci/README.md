...
| Domaine | Couverture |
| ------- | ---------- |
| **Tests automatisés** | **1379 tests verts** (Vitest) sur 25 fichiers — paie, recrutement, absences, contrats, employés, expenses, reporting, training, careers, mobile-money (28 tests dont 11 webhooks HMAC), IA assistant, CNPS, settings (28 tests dont 11 imports conformes BD), référentiels, authentification (plugin + routes), packs législatifs, workflows, security headers, **36 fixtures golden** (985 assertions)  |
