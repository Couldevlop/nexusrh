...
| Domaine | Couverture |
| ------- | ---------- |
| **Tests automatisés** | **1073 tests verts** (Vitest) sur 20 fichiers — paie, recrutement, absences, contrats, employés, expenses, reporting, training, careers, mobile-money, authentification, packs législatifs, référentiels, workflows |
