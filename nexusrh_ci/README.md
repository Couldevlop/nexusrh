...
| Domaine | Couverture |
| ------- | ---------- |
| **Tests automatisés** | **701 tests verts** (Vitest) sur 17 fichiers — paie, recrutement, absences, contrats, employés, expenses, reporting, training, authentification, packs législatifs, référentiels, workflows |
| **Golden fixtures paie** | 16 cas type figés au franc CFA près (célibataire, marié + enfants, haut salaire, primes transport/ancienneté/rendement/ICP, congé maternité complet/partiel, maladie maintien 50%/100%, AT avec jour J inclus/hors mois, heures supp, avance, SMIG exact (cas limite), haut salaire 3 enfants) |
