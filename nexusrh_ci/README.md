...
| Domaine | Couverture |
| ------- | ---------- |
| **Tests automatisés** | **1195 tests verts** (Vitest) sur 23 fichiers — paie, recrutement, absences, contrats, employés, expenses, reporting, training, careers, mobile-money, IA assistant, CNPS, authentification (plugin + routes), packs législatifs, référentiels, workflows, **31 fixtures golden** (846 assertions)  |
