...
| Domaine | Couverture |
| ------- | ---------- |
| **Tests automatisés** | **894 tests verts** (Vitest) sur 19 fichiers — paie, recrutement, absences, contrats, employés, expenses, reporting, training, careers, authentification, packs législatifs, référentiels, workflows |
