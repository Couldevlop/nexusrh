...
| Domaine | Couverture |
| ------- | ---------- |
| **Tests automatisés** | **1182 tests verts** (Vitest) sur 22 fichiers — paie, recrutement, absences, contrats, employés, expenses, reporting, training, careers, mobile-money, IA assistant, authentification (plugin + routes), packs législatifs, référentiels, workflows, **31 fixtures golden** (846 assertions)  |
