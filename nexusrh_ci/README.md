...
| Domaine | Couverture |
| ------- | ---------- |
| **Tests automatisés** | **1452 tests verts** (Vitest) sur 26 fichiers — paie, recrutement, absences, contrats, employés, expenses, reporting, training, careers, mobile-money (28 tests dont 11 webhooks HMAC), IA assistant, CNPS, settings (28 tests dont 11 imports conformes BD), référentiels, legal-watch (15 tests), authentification (plugin + routes), packs législatifs, workflows, security headers, **38 fixtures golden** (1044 assertions)  |
