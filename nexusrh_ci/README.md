...
| Domaine | Couverture |
| ------- | ---------- |
| **Tests automatisés** | **976 tests verts** (Vitest) sur 19 fichiers — paie, recrutement, absences, contrats, employés, expenses, reporting, training, careers, authentification, packs législatifs, référentiels, workflows |
