...
| Domaine | Couverture |
| ------- | ---------- |
| **Tests automatisés** | **1090 tests verts** (Vitest) sur 21 fichiers — paie, recrutement, absences, contrats, employés, expenses, reporting, training, careers, mobile-money, IA assistant, authentification, packs législatifs, référentiels, workflows |
