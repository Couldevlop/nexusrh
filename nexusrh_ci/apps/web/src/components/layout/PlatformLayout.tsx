...
import { LayoutDashboard, Building2, LogOut, Settings, Scale, Briefcase, Sparkles, ScrollText, Landmark } from 'lucide-react'
...
const NAV = [
  ...
  { to: '/platform/legislation',  labelKey: 'nav.legislation', icon: Landmark },
