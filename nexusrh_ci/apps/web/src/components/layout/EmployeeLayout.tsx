...
import { Home, Calendar, FileText, User, LogOut, Receipt, BookOpen, TrendingUp, Menu, X, Briefcase, Rocket, MessageSquare, Clock, AlertTriangle, MessagesSquare } from 'lucide-react'
